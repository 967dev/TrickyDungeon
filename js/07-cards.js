...
const CARD_ART=new Set([
  ...
  /* четвёртая партия, 3 сентября 2026 — тир ЛЕГЕНДА целиком, «Сердце Бездны»
     и секретный «Билет в Один Конец».
     Без арта остались двое: s09 «Шип Тишины» и zC0 «Перезарядка» — последняя
     обучающая, в коллекцию не попадает вовсе (noColl). */
  'L01','L02','L03','L04','L05','L06','s08','X01',
]);
