...
cafe:{id:'cafe',art:'art/story/cafe',intro:'КОФЕЙНЯ',title:'КОФЕЙНЯ',
  foe:'',mood:{1:'calm',2:'joy',3:'calm',4:'calm'},
  caps:{1:'рекламный щит на улице',2:'заказ у стойки',
        3:'за столиком у окна',4:'соседний столик'},
  beats:[
{a:1,l:[['t','Надо проветриться и попить кофейку.']]},                 /* СВЯЗКА */
/* Текст щита — ВРЕЗКА в картинку, на пустое жёлтое поле: «БАМ-ПАК. 100 искр и
   лучшие карты сезона у тебя в колоде». Репликой он быть не может — это не
   слова героя и не слова собеседника, а то, что нарисовано на улице. */
...
morning:{id:'morning',art:'art/story/morning',intro:'УТРО. ЗВОНОК',title:'УТРО. ЗВОНОК',
  foe:'',mood:{1:'calm',2:'angry',3:'angry',4:'angry',5:'calm'},
...
final:{id:'final',art:'art/story/final',intro:'ФИНАЛЬНЫЙ ДЕНЬ ТУРНИРА',title:'ФИНАЛЬНЫЙ ДЕНЬ',
  foe:'ШШ',mood:{1:'calm',2:'angry',3:'calm',4:'calm'},
...
win:{id:'win',art:'art/story/win',intro:'ФИНАЛ ВЗЯТ',title:'ФИНАЛ ВЗЯТ',
  foe:'ШШ',mood:{1:'joy',2:'joy',3:'joy',4:'joy'},
...
function vnShow(){
  ...
  const ov=$('#vnOver');
  if(ov){
    if(b.over){ov.hidden=false;ov.textContent=sub(b.over.t||'');
      ov.style.left=b.over.x||'50%';ov.style.top=b.over.y||'50%'}
    else ov.hidden=true;
  }
