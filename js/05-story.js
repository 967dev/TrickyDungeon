...
{a:1,l:[['n','БАМ-ПАК. 100 искр и лучшие карты сезона у тебя в колоде.']]},
{a:2,l:[['t','БАМ-БАМБЛ. Маркетологи БАМ-БАМ пытаются раскрутиться где только можно.']]},
{a:3,l:[['n','За соседним столиком разговаривают.']]},                 /* СВЯЗКА */
...
{a:4,l:[['n','Телефон остаётся на кровати.']]},                        /* СВЯЗКА */
{a:5,l:[['n','В полутёмной комнате человек в костюме смотрит на экран. На экране радар. На радаре мигает точка с подписью — {NAME}.']]},
]},
...
{a:2,l:[['n','Напротив зеркала. Настроиться на бой.']]},               /* СВЯЗКА */
...
win:{id:'win',art:'art/story/win',intro:'ФИНАЛ ВЗЯТ',title:'ФИНАЛ ВЗЯТ',
  ...
  beats:[
{a:1,l:[['n','Чат заливает: «ЛУЗЕР», «ДОМОЙ», «БОТ 1 ЭЛО», «ПОПУЩЕН».']]},
{a:2,l:[['n','Трон. Корона. Так это ощущается.']]},                    /* СВЯЗКА */
{a:3,l:[['n','Компьютерное кресло. Бумажная корона. Так это выглядит.']]},  /* СВЯЗКА */
{a:4,l:[['n','Поздравляем с победой в турнире! Баланс искр пополнен.']]},   /* СВЯЗКА */
]},
