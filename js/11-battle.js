...
/* Заводка боя ВДВОЁМ. Отдельной функцией, а не условиями внутри startBattle:
   ...
   ЗАМЕНЫ РУКИ В ДУЭЛИ НЕТ. Не из-за сложности: экран замены надо было бы
   показать обоим и дождаться обоих, то есть завести ещё одно согласование до
   первого хода. Обе стороны без замены — уже честно.
  ...
  const рисовать=()=>{
    ...
    box.innerHTML=`<div class="mullBox">
      ...
      <div class="mullS">Колода тасуется заново перед каждым боем. Не нравится рука —
        верни в колоду до двух карт и возьми взамен другие.</div>
