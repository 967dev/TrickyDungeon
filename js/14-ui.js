...
function openInfo(tab){
  ...
  const C={
   ...
   strat:`<h3>КАК УРОНИТЬ ЗДОРОВЬЕ СОПЕРНИКА</h3>
    ...
    <li><b>АоЕ копи</b>: «Фонотека» и «Сердце Бездны» жалко тратить по одному юниту — жди, пока враг развернёт 3-4.</li>
   ...
   raid:`<h3>КАРТА ГОРОДА</h3>
    <ul>
    <li>Район города — это акт. Внутри района <b>10 провалов</b>, каждый — карточный бой с ИИ.</li>
    <li>Открываются по очереди. Зачистишь район целиком — туман сойдёт с соседнего, и дорога сама к нему проложится.</li>
    <li>Под мутью не видно ничего: ни сколько там районов, ни какие они. Один шаг вперёд угадывается всегда.</li>
