...
function openInfo(tab){
  ...
  const C={
   battle:`<h3>КАК ПОБЕДИТЬ</h3>
    ...
    <ul>
    <li>На старте у тебя <b>3 карты из колоды</b> плюс <b>«Перезарядка»</b> — её дают сверх колоды, в самой колоде её нет.</li>
    <li>Перед боем показывают руку и дают <b>вернуть в колоду до двух карт</b>, взяв взамен другие. Тапни карту, чтобы пометить.</li>
